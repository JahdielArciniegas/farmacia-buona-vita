        ...
        <div>
          <picture>
            <img
              ...
              className="w-1/2 object-contain absolute top-0 -left-16 -z-10"
            />
          </picture>
        </div>
      </div>
